@push('css')
    ...
    <style>
        ...
        .teacher-identity-meta {
            margin: 0;
            color: #6b7f9f;
            font-size: 0.82rem;
        }

        .teacher-identity-badges {
            display: flex;
            gap: 8px;
            flex-wrap: wrap;
            margin-top: 8px;
        ...
        body.dark .teacher-identity {
            border-color: rgba(150, 184, 229, 0.24);
            background: linear-gradient(145deg, rgba(24, 37, 57, 0.95), rgba(17, 30, 48, 0.95));
        }

        body.dark .teacher-identity-title,
        body.dark .teacher-identity-meta {
            color: #abc0e0;
        }

        body.dark .teacher-identity-name {
            color: #e2ecff;
        }
    </style>
@endpush
        ...
        <div class="col-md">
            <div class="card">
                <div class="card-header">
                    <h5>Sebaran Mahasiswa Pamongan</h5>
                </div>
                <div class="card-body">
                    <div class="teacher-identity">
                        <p class="teacher-identity-title">Identitas Guru Pamong</p>
                        <p class="teacher-identity-name">{{ auth()->user()->name ?? '-' }}</p>
                        <p class="teacher-identity-meta">{{ auth()->user()->username ?? '-' }}</p>
                        <div class="teacher-identity-badges">
