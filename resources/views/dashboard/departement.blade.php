<div class="content-wrapper">
    <div class="row same-height">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5>Kuota dan Hasil Pemetaan Mahasiswa {{ auth()->user()->subjects->departement }} pada PLP Tahun 2022</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table small-font table-striped table-hover table-sm">
                            ...
                            <tbody>
                                @php
                                    $maps = App\Models\Map::select('school_id')->where('subject_id',auth()->user()->subject_id)->groupBy('school_id')->get();
                                @endphp
                                @foreach ($maps as $map)
                                <tr>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5>Pemetaan DPL {{ auth()->user()->subjects->departement }} pada PLP Tahun 2022</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table small-font table-striped table-hover table-sm">
