@php
    ...
    if (auth()->user()->hasAnyRole('kajur')) {
        $subjects = App\Models\Subject::where('id',auth()->user()->subject_id)->get();
    }
...
<div class="col-auto">
    <div class="card">
        <div class="card-header">
            ...
            @role('kajur'){{ App\Models\Subject::find(auth()->user()->subject_id)->departement }}@endrole
        </div>
        <div class="card-body">
            ...
            @php
                ...
                $percent = $quota->count()==0 ? 0 : round($assessed/(3*$quota->count()) * 100,2);
            @endphp
