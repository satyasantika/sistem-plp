<div class="col-auto">
    <div class="card">
        <div class="card-header">
            ...
            @if (!empty($departmentData['departmentLabel'])){{ $departmentData['departmentLabel'] }}@endif
        </div>
        <div class="card-body">
            ...
            <div data-progress-subject-switcher>
                <div class="progress-toolbar">
                    @if (count($cards) > 1)
                    <div>
                        <label for="progress-only-subject-select">Pilih Prodi</label>
                        <select id="progress-only-subject-select" class="js-progress-subject-select form-select">
                ...
                @foreach ($cards as $subjectCard)
                <div class="progress-subject-view" data-subject-id="{{ $subjectCard['id'] }}" @if($subjectCard['id'] !== $cards[0]['id']) hidden @endif>
                    <div class="progress-toolbar">
