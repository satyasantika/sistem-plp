<div class="modal-content">
    <form id="formAction" action="{{ $studentobservation->id ? route('studentobservations.update',['studentobservation'=>$studentobservation->id,'form_id'=>$form->id]) : route('studentobservations.store',['form_id' => $form->id]) }}" method="post">
        @csrf
