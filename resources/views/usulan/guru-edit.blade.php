                ...
                <div class="card">
                    <div class="card-body">
                        <div class="modal-content">
                            <form id="formAction" action="{{ route('teachers.update',$teacher->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" value="{{ $teacher->candidate_name }}" name="candidate_name" class="form-control" id="candidate_name" required autofocus>
                                            </div>
                                        </div>
