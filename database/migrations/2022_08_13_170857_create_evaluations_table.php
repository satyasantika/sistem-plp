...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('observations', function (Blueprint $table) {
            ...
            $table->foreign('form_id')->references('id')->on('forms')->constrained();
            $table->integer('form_order');
            $table->integer('item01')->nullable();
            $table->integer('item02')->nullable();
            $table->integer('item03')->nullable();
            $table->integer('item04')->nullable();
            $table->integer('item05')->nullable();
            $table->integer('item06')->nullable();
            $table->integer('item07')->nullable();
            $table->longText('note')->nullable();
            $table->timestamps();
        });
    }
