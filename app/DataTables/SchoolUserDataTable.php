...
class SchoolUserDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\SchoolUser $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SchoolUser $model): QueryBuilder
    {
    ...
    {
        return 'SchoolUser_' . date('YmdHis');
    }
}
